...
"/js/onlineInterface/history/onlineInterfaceHistoryCore.js", "/js/onlineInterface/history/onlineInterfaceHistory.js"]
/>
            ...
            <div class="col-sm-12">
                ...
                <div class="col-sm-9 form-inline">
			        <select id="compareSelect" class="form-control" style="width: 20%; font-size: 14px; margin: 45px -6% 0">
		                ...
		                <#list onlineVersions as version>
		                	<option value="${version.onlineVersionId!''}">${version.createTime?string("yyyy-MM-dd HH:mm:ss")!''} - 版本${version.versionNum!''}</option>
		                </#list>
	                </select>
		...
		<div class="row">
			<div class="col-sm-3" style="width: 25%;margin-bottom: 80px;">
				<div class="panel panel-info">
					<#if onlineVersions?exists && onlineVersions?size gt 0>
	                			...
	                			<ul>
			                		<#list onlineVersions as version>
			                			<#if version.versionDesc?contains('迭代版本-')>
				                			<li id="version-${version.onlineVersionId }" version="${version.onlineVersionId }"> &nbsp; <i class="glyphicon glyphicon-file" style="color: #ccff80"></i>
				                				<a href="#" class="version-item" id="${version.onlineVersionId!''}" onclick="initVersionInfo(${version.onlineVersionId!''}, true);return false;" style="margin-left:6px;" title="描述信息：${version.versionDesc!''}">${version.createTime?string("yyyy-MM-dd HH:mm:ss")!''} - 版本${version.versionNum!''} <#if version.versionNum gt 9>&nbsp;&nbsp;<#else>&nbsp;&nbsp;&nbsp;&nbsp;</#if><label class='btn btn-xs btn-success'>${version.versionDesc!''}</label></a>
				                			</li>
				                		<#else>
				                			<li id="version-${version.onlineVersionId }" version="${version.onlineVersionId }"> &nbsp; <i class="glyphicon glyphicon-file" style="color: #ccff80"></i>
				                				<a href="#" class="version-item" id="${version.onlineVersionId!''}" onclick="initVersionInfo(${version.onlineVersionId!''}, true);return false;" style="margin-left:6px;" title="描述信息：${version.versionDesc!''}">${version.createTime?string("yyyy-MM-dd HH:mm:ss")!''} - 版本${version.versionNum!''}</a>
				                			</li>
				                		</#if>
			                		</#list>
	                			</ul>
