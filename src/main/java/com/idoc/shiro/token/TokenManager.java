...
import com.idoc.util.SpringContextUtil;

/**
 * Shiro管理下的Token工具类
 * 
 * @author bjhuwei1
 * @version 创建时间：2017年7月19日 下午4:45:37
 */
public class TokenManager {
	// 用户登录管理
	public static final SampleRealm realm = SpringContextUtil.getBean("sampleRealm", SampleRealm.class);
	//用户session管理
	public static final DefaultWebSessionManager sessionManager = SpringContextUtil.getBean("sessionManager",DefaultWebSessionManager.class);
	...
	public static boolean isAdmin() {
		return getSubject().hasRole("888888");
	}
	 ...
	 * @return
	 */
	public static UserModel login(UserModel user, Boolean rememberMe) {
