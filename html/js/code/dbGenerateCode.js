...
$(document).ready(function(){
	...
	var data = {};
	data.databaseDriver = $.cookie('databaseDriver');
	data.databaseUrl = $.cookie('databaseUrl');
	data.userName = $.cookie('userName');
	data.password = decodeURI($.cookie('password'));
	data.databaseName = $.cookie('databaseName');
	data.params = $.cookie('params');

	$.ajax({
		url:'/idoc/code/dbGenerateCode.html',
		type:'POST',
		dataType:'json',
		async: false,
		data: data,
